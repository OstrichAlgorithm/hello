...
insert  into `app_role`(`app_id`,`role_id`) values (1,1),(1,2),(2,1),(2,2),(3,1),(4,1),(4,2),(5,1),(5,2),(6,1),(6,2),(7,1),(7,2),(8,1),(8,2),(9,1),(9,2),(10,1),(10,2),(11,1),(11,2),(12,1),(12,2),(13,1),(13,2),(14,1),(14,2),(15,1),(15,2),(16,1),(16,2),(17,1),(17,2);
...
insert  into `bpm_flow_role`(`bpm_flow_id`,`role_id`) values (1,1),(1,2);
...
insert  into `role`(`id`,`name`,`alias`) values (1,'SA','超级管理员'),(2,'AM','普通管理员');
...
insert  into `role_priv`(`role_id`,`priv_id`) values (1,1),(1,2);
...
CREATE TABLE `private_info`(
	...
	`brithday`	timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	`height` int(5),
	`weight` int(5),
	`qq`	int(20),
	`phone` int(20), 
...
CREATE TABLE `paper`(
	`id` int(10) NOT NULL AUTO_INCREMENT,
	`paper_from` int(10) NOT NULL,
	`paper_to`	int(10) NOT NULL,
	`des`	varchar(200) ,
